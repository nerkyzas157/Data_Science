...
- Loaded the MNIST dataset, which contains a large collection of handwritten digit images.
- Preprocessed the data by scaling pixel values to be between 0 and 1.
- Built and trained a Convolutional Neural Network model using TensorFlow/Keras.
- Evaluated the model's accuracy on a test dataset.
- Visualized sample images along with their predicted labels to assess the model's performance.
- Used Matplotlib and NumPy visualize my CNN model results.
